                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            <router-link v-for="item in navigation" :key="item.name" active-class="bg-gray-900 text-white" :to="item.to" :class="[this.router.name === item.to.name ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white', 'px-3 py-2 rounded-md text-sm font-medium']">
        ...
        <DisclosurePanel class="md:hidden">
            ...
            <div class="border-t border-gray-700 pt-4 pb-3">
                ...
                <div class="mt-3 space-y-1 px-2">
                    <DisclosureButton as="a" @click="log" class="block rounded-md px-3 py-2 text-base font-medium cursor-pointer text-gray-400 hover:bg-gray-700 hover:text-white">
                        SignOut
                    </DisclosureButton>
                </div>
            </div>
